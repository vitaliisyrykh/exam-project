  ...
  return (
    <section >
      ...
      <div className={styles.progressContainer}>
        ...
        <div className={styles.progress } >
          <img src='https://www.squadhelp.com/resources/assets/imgs/front/sharing-files.svg' className={styles.modifImg}/>
          <p className={styles.modif}><span>140+ Industries </span> supported across more than <span>85 countries</span> – and counting.</p>
        </div>
      </div>
    </section>
  );
